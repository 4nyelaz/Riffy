...
public class AdminController {
    ...
    @ResponseBody
    public ResponseEntity<List<UsuarioEntity>> listarUsuarios(HttpSession session) {
    ...
    @ResponseBody
    public ResponseEntity<?> eliminarUsuario(@PathVariable @NonNull Long id, HttpSession session) {
        if (!esAdmin(session)) return ResponseEntity.status(403).build();
    ...
    @ResponseBody
    public ResponseEntity<List<ProductoEntity>> listarProductos(HttpSession session) {
        if (!esAdmin(session)) return ResponseEntity.status(403).build();
    ...
    @ResponseBody
    public ResponseEntity<List<ConversacionEntity>> listarConversaciones(HttpSession session) {
        if (!esAdmin(session)) return ResponseEntity.status(403).build();
